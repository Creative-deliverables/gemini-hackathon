...
교보문고/영풍문고/부크크/예스24/알라딘의 폼에 맞게 커리큘럼 구조를 강조하는 버전으로 생성해줘."
```
...
- `넥서스 인사이트 2026 한국편(완고 9mb).pdf` — 최근 한국 동향 분석
- `넥서스 인사이트 2026 중국편(완고 6MB).pdf` — 최근 중국 동향 분석
...
- [ ] 플랫폼별 프롬프트 최적화 (교보문고, 영풍문고, 예스24, 부크크, 알라딘)
- [ ] 로딩 상태 및 에러 처리 UI
- [ ] 상세페이지 미리보기 레이아웃
